...
/**
 * HTTP_OAuthProvider_Signature_RSA_SHA1Test
 *
 * @category HTTP
 * @package  OAuthProvider
 * @author   Tetsuya Yoshida <tetu@eth0.jp>
 ...
 * @link     http://openpear.org/package/HTTP_OAuthProvider
 */
class HTTP_OAuthProvider_Signature_RSA_SHA1Test extends PHPUnit_Framework_TestCase
{
    /** 
     * setUp
     * 
    ...
    {
        $this->provider = new HTTP_OAuthProvider_Mock_RSA_SHA1();
