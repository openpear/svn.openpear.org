...
/**
 * HTTP_OAuthProvider_Store_MemcachedTest
 *
 * @category HTTP
 * @package  OAuthProvider
 * @author   Tetsuya Yoshida <tetu@eth0.jp>
 ...
 * @link     http://openpear.org/package/HTTP_OAuthProvider
 */
class HTTP_OAuthProvider_Store_MemcachedTest extends PHPUnit_Framework_TestCase
{
    /** 
     * setUp
     * 
    ...
    public function setUp()
    {
        ...
        $this->store = HTTP_OAuthProvider_Store::factory('Memcached');
    }
