 ...
 */
class PEAR_PackageProjector_ProjectInfo_Dependencies implements PEAR_PackageProjector_Visitor {
     ...
     *
     */
    public function add(PEAR_PackageProjector_ProjectInfo_Dependency $dependency)
    {
    ...
    {
        foreach ($this->dependencies as $num=>$value) {
