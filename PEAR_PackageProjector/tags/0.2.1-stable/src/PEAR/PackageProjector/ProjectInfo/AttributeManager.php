 ...
 */
class PEAR_PackageProjector_ProjectInfo_AttributeManager implements PEAR_PackageProjector_Visitor {
    private $attribures;
    ...
    {
        if (!isset($this->attribures[$path])) {
            $this->attribures[$path] = new PEAR_PackageProjector_ProjectInfo_Attribute($path);
        }
        return $this->attribures[$path];
    }
    ...
    {
        foreach ($this->attribures as $num=>$value) {
