 ...
 */
class PEAR_PackageProjector_ProjectInfo_ReleaseVersion implements PEAR_PackageProjector_Visitor {
    ...
    public function visit(PEAR_PackageProjector_Package $package)
    {
        ...
        $handler->buildMessage(5, "Setting release version... {$this->version}", true);
