 ...
 */
class PEAR_PackageProjector_ProjectInfo_InstallGroup implements PEAR_PackageProjector_Visitor {
    private $name;
    ...
    {
        $this->name = preg_replace("/[^a-z0-9\_]/i", "_", $name);
     ...
     *
     */
    public function add(PEAR_PackageProjector_ProjectInfo_InstallParam $param)
    {
        $this->params[] = $param;
    }
