 ...
 */
class PEAR_PackageProjector_ProjectInfo_InstallGroups implements PEAR_PackageProjector_Visitor {
    private $groups;
     ...
     *
     */
    public function add(PEAR_PackageProjector_ProjectInfo_InstallGroup $group)
    {
        $this->groups[] = $group;
    }
    ...
    {
        foreach ($this->groups as $num=>$value) {
