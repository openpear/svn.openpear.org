 ...
 */
class PEAR_PackageProjector_ProjectInfo_Dependency implements PEAR_PackageProjector_Visitor {
    private $name;
    private $type;
    private $channel;
    private $min;
     ...
     */
    public function __construct($type, $name, $channel, $min = false, $max = false, $recommended = false, $exclude = false, $providesextension = false, $nodefault = false)
    {
        $this->type              = $type;
        $this->name              = $name;
        ...
        $this->providesextension = $providesextension;
