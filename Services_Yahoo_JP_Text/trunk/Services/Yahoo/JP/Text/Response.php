...
/**
 * Services_Yahoo_JP Text Response
 *
 * PHP version 5
 *
...
/**
 * Services_Yahoo Text Response class
 *
 ...
 */
class Services_Yahoo_JP_Text_Response implements Iterator
{
    /**
     * validate flag
     *
    ...
    public function __construct(HTTP_Request $request)
    {
        ...
        if ($this->_isError() == true) {
            $exception = new Services_Yahoo_Exception("Text query failed");
    ...
    {
        return count((array)$this->xml->Result->ChunkList->Chunk);
    }
    ...
    {
        return (array)$this->xml->Result->ChunkList->Chunk[$this->_iteratorCounter];
    }
    ...
    public function next()
    {
        ...
        if (!isset($this->xml->Result->ChunkList->Chunk[$this->_iteratorCounter])) {
