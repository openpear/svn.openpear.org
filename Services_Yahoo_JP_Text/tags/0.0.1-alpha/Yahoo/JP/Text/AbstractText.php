 ...
 * @version   SVN: $Id: AbstractText.php,v 1.1 2008/04/28 15:59:30 tetsuya Exp $
 */

require_once 'Services/Yahoo/JP/Text/Response.php';
 ...
 * types of Text that available through Services_Yahoo.
 *
 * @category  Services
 * @package   Services_Yahoo_JP_Text
 * @author    Hideyuki Shimooka <shimooka@doyouphp.jp>
 ...
 */
abstract class Services_Yahoo_JP_Text_AbstractText
{
    /**
     * parameter
     *
     ...
     * @var    array
     */
    protected $parameters = array('appid' => 'PEAR_Services_Y_JP_Text');

    /**
     * Submits the Text
     *
     * This method submits the Text and handles the response.  It
     * returns an instance of Services_Yahoo_Result which may be used
     * to further make use of the result.
     *
     * @return object Services_Yahoo_Response Text result
    ...
    public function submit()
    {
        ...
        return new Services_Yahoo_JP_Text_Response($request);
    }
     ...
     * Set the sentence
     *
     * @param string $word sentence to parse
     *
     * @return void
     */
