 ...
 * FTP main file.
 *
 * This file must be included to use the FTP package.
 *
 ...
 * @link       http://pear.php.net/package/FTP
 ...
 *
 * @since 1.3
 * @name FTP_ERR_CONNECT_FAILED
 * @see FTP::connect()
 */
define('FTP_ERR_CONNECT_FAILED', -1);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_LOGIN_FAILED
 * @see FTP::login()
 */
define('FTP_ERR_LOGIN_FAILED', -2);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_DIRCHANGE_FAILED
 * @see FTP::cd()
 */
define('FTP_ERR_DIRCHANGE_FAILED', 2); // Compatibillity reasons!

/**
 * Error code to indicate that FTP could not determine the current path
 * The cwd() method failed and could not determine the path you currently reside
 * in on the FTP server.
 *
 * @since 1.3
 * @name FTP_ERR_DETERMINEPATH_FAILED
 * @see FTP::pwd()
 */
define('FTP_ERR_DETERMINEPATH_FAILED', 4); // Compatibillity reasons!
 ...
 *
 * @since 1.3
 * @name FTP_ERR_CREATEDIR_FAILED
 * @see FTP::mkdir()
 */
define('FTP_ERR_CREATEDIR_FAILED', -4);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_EXEC_FAILED
 * @see FTP::execute()
 */
define('FTP_ERR_EXEC_FAILED', -5);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_SITE_FAILED
 * @see FTP::site()
 */
define('FTP_ERR_SITE_FAILED', -6);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_CHMOD_FAILED
 * @see FTP::chmod()
 */
define('FTP_ERR_CHMOD_FAILED', -7);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_RENAME_FAILED
 * @see FTP::rename()
 */
define('FTP_ERR_RENAME_FAILED', -8);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_MDTMDIR_UNSUPPORTED
 * @see FTP::mdtm()
 */
define('FTP_ERR_MDTMDIR_UNSUPPORTED', -9);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_MDTM_FAILED
 * @see FTP::mdtm()
 */
define('FTP_ERR_MDTM_FAILED', -10);
 ...
 * send an email to the auhtor with a dumped output of $ftp->ls('./', FTP_RAWLIST);
 * to get the date format supported.
 *
 * @since 1.3
 * @name FTP_ERR_DATEFORMAT_FAILED
 * @see FTP::mdtm(), FTP::ls()
 */
define('FTP_ERR_DATEFORMAT_FAILED', -11);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_SIZE_FAILED
 * @see FTP::size()
 */
define('FTP_ERR_SIZE_FAILED', -12);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_OVERWRITELOCALFILE_FORBIDDEN
 * @see FTP::get(), FTP::getRecursive()
 */
define('FTP_ERR_OVERWRITELOCALFILE_FORBIDDEN', -13);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_OVERWRITELOCALFILE_FAILED
 * @see FTP::get(), FTP::getRecursive()
 */
define('FTP_ERR_OVERWRITELOCALFILE_FAILED', -14);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_LOCALFILENOTEXIST
 * @see FTP::put(), FTP::putRecursive()
 */
define('FTP_ERR_LOCALFILENOTEXIST', -15);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_OVERWRITEREMOTEFILE_FORBIDDEN
 * @see FTP::put(), FTP::putRecursive()
 */
define('FTP_ERR_OVERWRITEREMOTEFILE_FORBIDDEN', -16);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_UPLOADFILE_FAILED
 * @see FTP::put(), FTP::putRecursive()
 */
define('FTP_ERR_UPLOADFILE_FAILED', -17);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_REMOTEPATHNODIR
 * @see FTP::putRecursive(), FTP::getRecursive()
 */
define('FTP_ERR_REMOTEPATHNODIR', -18);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_LOCALPATHNODIR
 * @see FTP::putRecursive(), FTP::getRecursive()
 */
define('FTP_ERR_LOCALPATHNODIR', -19);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_CREATELOCALDIR_FAILED
 * @see FTP::getRecursive()
 */
define('FTP_ERR_CREATELOCALDIR_FAILED', -20);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_HOSTNAMENOSTRING
 * @see FTP::setHostname()
 */
define('FTP_ERR_HOSTNAMENOSTRING', -21);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_PORTLESSZERO
 * @see FTP::setPort()
 */
define('FTP_ERR_PORTLESSZERO', -22);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_NOMODECONST
 * @see FTP::setMode()
 */
define('FTP_ERR_NOMODECONST', -23);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_TIMEOUTLESSZERO
 * @see FTP::FTP(), FTP::setTimeout()
 */
define('FTP_ERR_TIMEOUTLESSZERO', -24);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_SETTIMEOUT_FAILED
 * @see FTP::FTP(), FTP::setTimeout()
 */
define('FTP_ERR_SETTIMEOUT_FAILED', -25);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_EXTFILENOTEXIST
 * @see FTP::getExtensionFile()
 */
define('FTP_ERR_EXTFILENOTEXIST', -26);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_EXTFILEREAD_FAILED
 * @see FTP::getExtensionFile()
 */
define('FTP_ERR_EXTFILEREAD_FAILED', -27);
 ...
 * @see FTP::rm()
 */
define('FTP_ERR_DELETEFILE_FAILED', -28);
 ...
 * @see FTP::rm()
 */
define('FTP_ERR_DELETEDIR_FAILED', -29);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_RAWDIRLIST_FAILED
 * @see FTP::ls()
 */
define('FTP_ERR_RAWDIRLIST_FAILED', -30);

/**
 * Error code to indicate that the directory listing failed
 * The directory listing format your server uses seems not to
 * be supported by FTP. Please send the output of the
 * call ls('./', FTP_RAWLIST); to the author of this
 * class to get it supported.
 *
 * @since 1.3
 * @name FTP_ERR_DIRLIST_UNSUPPORTED
 * @see FTP::ls()
 */
define('FTP_ERR_DIRLIST_UNSUPPORTED', -31);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_DISCONNECT_FAILED
 * @see FTP::disconnect()
 */
define('FTP_ERR_DISCONNECT_FAILED', -32);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_USERNAMENOSTRING
 * @see FTP::setUsername()
 */
define('FTP_ERR_USERNAMENOSTRING', -33);
 ...
 *
 * @since 1.3
 * @name FTP_ERR_PASSWORDNOSTRING
 * @see FTP::setPassword()
 */
define('FTP_ERR_PASSWORDNOSTRING', -33);
...
class FTP extends PEAR 
{
    ...
    /**
     * Holds all FTP_Observer objects 
     ...
     * @return  void
     * @see     FTP::setHostname(), FTP::setPort(), FTP::connect()
     */
    
    function FTP($host = null, $port = null, $timeout = 90)
    {
        $this->PEAR();
        if (isset($host)) {
    ...
    function connect($host = null, $port = null)
    {
        ...
        if (!$handle) {
            return $this->raiseError("Connection to host failed", FTP_ERR_CONNECT_FAILED);
        } else {
            $this->_handle =& $handle;
            return true;
        }
    ...
    function disconnect()
    {
        ...
        if (!$res) {
            return PEAR::raiseError('Disconnect failed.', FTP_ERR_DISCONNECT_FAILED);
        }
        return true;
    }
    ...
    function login($username = null, $password = null)
    {
        ...
        if (!$res) {
            return $this->raiseError("Unable to login", FTP_ERR_LOGIN_FAILED);
        } else {
            return true;
        }
    }
    ...
    function cd($dir)
    {
        ...
        if (!$erg) {
            return $this->raiseError("Directory change failed", FTP_ERR_DIRCHANGE_FAILED);
        } else {
            return true;
        }
    }
     ...
     * @see     FTP_ERR_DETERMINEPATH_FAILED
     */
    ...
    function pwd()
    {
        ...
        if (!$res) {
            return $this->raiseError("Could not determine the actual path.", FTP_ERR_DETERMINEPATH_FAILED);
        } else {
            return $res;
        }
    }
    ...
    function mkdir($dir, $recursive = false)
    {
        ...
        if ($recursive === false){
            ...
            if (!$res) {
                return $this->raiseError("Creation of '$dir' failed", FTP_ERR_CREATEDIR_FAILED);
            } else {
                return true;
            }
        } else {
    ...
    function execute($command)
    {
        ...
        if (!$res) {
            return $this->raiseError("Execution of command '$command' failed.", FTP_ERR_EXEC_FAILED);
        } else {
            return $res;
        }
    }
    ...
    function site($command)
    {
        ...
        if (!$res) {
            return $this->raiseError("Execution of SITE command '$command' failed.", FTP_ERR_SITE_FAILED);
        } else {
            return $res;
        }
    }
    ...
    function chmod($target, $permissions)
    {
        ...
        if (is_array($target)) {
            ...
            if (!$res) {
                return PEAR::raiseError("CHMOD " . $permissions . " " . $target . " failed", FTP_ERR_CHMOD_FAILED);
            } else {
                return $res;
            }
     ...
     * @return  mixed                  True if successful, otherwise PEAR::Error
     * @see     FTP_ERR_CHMOD_FAILED, FTP_ERR_DETERMINEPATH_FAILED, FTP_ERR_RAWDIRLIST_FAILED, FTP_ERR_DIRLIST_UNSUPPORTED
     */
    ...
    function rename ($remote_from, $remote_to) 
    {
        ...
        if(!$res) {
            return $this->raiseError("Could not rename ".$remote_from." to ".$remote_to." !", FTP_ERR_RENAME_FAILED);
        }
        return true;
    }
     ...
     * @see     FTP_ERR_MDTMDIR_UNSUPPORTED, FTP_ERR_MDTM_FAILED, FTP_ERR_DATEFORMAT_FAILED
     */
    ...
    function mdtm($file, $format = null)
    {
        ...
        if ($this->_check_dir($file)) {
            return $this->raiseError("Filename '$file' seems to be a directory.", FTP_ERR_MDTMDIR_UNSUPPORTED);
        }
        $res = @ftp_mdtm($this->_handle, $file);
        if ($res == -1) {
            return $this->raiseError("Could not get last-modification-date of '$file'.", FTP_ERR_MDTM_FAILED);
        }
        if (isset($format)) {
            $res = date($format, $res);
            if (!$res) {
                return $this->raiseError("Date-format failed on timestamp '$res'.", FTP_ERR_DATEFORMAT_FAILED);
            }
        }
        return $res;
    }
    ...
    function size($file)
    {
        ...
        if ($res == -1) {
            return $this->raiseError("Could not determine filesize of '$file'.", FTP_ERR_SIZE_FAILED);
        } else {
            return $res;
        }
    }
     ...
     * the files (using FTP_FILES_ONLY), to list only directories (using
     * FTP_DIRS_ONLY) or to show both (using FTP_DIRS_FILES, which is default).
     * <BR><BR>
     * The 4th one is the FTP_RAWLIST, which returns just the array created by the
     ...
     * FTP_DIRS_FILES the directories will be added above the files,
     ...
     * @see     FTP_DIRS_FILES, FTP_DIRS_ONLY, FTP_FILES_ONLY, FTP_RAWLIST, FTP_ERR_DETERMINEPATH_FAILED, FTP_ERR_RAWDIRLIST_FAILED, FTP_ERR_DIRLIST_UNSUPPORTED
     */
     
    function ls($dir = null, $mode = FTP_DIRS_FILES)
    {
        if (!isset($dir)) {
            $dir = @ftp_pwd($this->_handle);
            if (!$dir) {
                return $this->raiseError("Could not retrieve current directory", FTP_ERR_DETERMINEPATH_FAILED);
            }
        }
        if (($mode != FTP_FILES_ONLY) && ($mode != FTP_DIRS_ONLY) && ($mode != FTP_RAWLIST)) {
            $mode = FTP_DIRS_FILES;
        }

        switch ($mode) {
            case FTP_DIRS_FILES:    $res = $this->_ls_both ( $dir );
                                        break;
            case FTP_DIRS_ONLY:     $res = $this->_ls_dirs ( $dir );
                                        break;
            case FTP_FILES_ONLY:    $res = $this->_ls_files ( $dir );
                                        break;
            case FTP_RAWLIST:       $res = @ftp_rawlist($this->_handle, $dir);
                                        break;
        }

        if ( PEAR::isERROR($res) && strlen($dir) > 1 ) {
            $result = $this->ls( dirname($dir), FTP_FILES_ONLY );
            if( ! PEAR::isERROR($result) ) {
                foreach( $result as $item ) {
                    if( $item['name'] == basename($dir) ) return $item;
                }
            }
        }
     ...
     * @return  mixed             True on success, otherwise PEAR::Error
     * @see     FTP_ERR_DELETEFILE_FAILED, FTP_ERR_DELETEDIR_FAILED, FTP_ERR_REMOTEPATHNODIR
     */
     ...
     * @return  mixed               True on success, otherwise PEAR::Error
     * @see     FTP_ERR_OVERWRITELOCALFILE_FORBIDDEN, FTP_ERR_OVERWRITELOCALFILE_FAILED, FTP_ERR_OVERWRITELOCALFILE_FAILED
     */
    ...
    function get($remote_file, $local_file, $overwrite = false, $mode = null)
    {
        ...
        if (@file_exists($local_file) && !$overwrite) {
            return $this->raiseError("Local file '$local_file' exists and may not be overwriten.", FTP_ERR_OVERWRITELOCALFILE_FORBIDDEN);
        }
        if (@file_exists($local_file) && !@is_writeable($local_file) && $overwrite) {
            return $this->raiseError("Local file '$local_file' is not writeable. Can not overwrite.", FTP_ERR_OVERWRITELOCALFILE_FAILED);
        }
        ...
        if (!$res) {
            return $this->raiseError("File '$remote_file' could not be downloaded to '$local_file'.", FTP_ERR_OVERWRITELOCALFILE_FAILED);
        } else {
            return true;
        }
    }
     ...
     * @param   int    $mode        (optional) Either FTP_ASCII or FTP_BINARY
     * @return  mixed               True on success, otherwise PEAR::Error
     * @see     FTP_ERR_LOCALFILENOTEXIST, FTP_ERR_OVERWRITEREMOTEFILE_FORBIDDEN, FTP_ERR_UPLOADFILE_FAILED
     */
    ...
    function put($local_file, $remote_file, $overwrite = false, $mode = null)
    {
        ...
        if (!@file_exists($local_file)) {
            return $this->raiseError("Local file '$local_file' does not exist.", FTP_ERR_LOCALFILENOTEXIST);
        }
        if ((@ftp_size($this->_handle, $remote_file) != -1) && !$overwrite) {
            return $this->raiseError("Remote file '$remote_file' exists and may not be overwriten.", FTP_ERR_OVERWRITEREMOTEFILE_FORBIDDEN);
        }
        ...
        if (!$res) {
            return $this->raiseError("File '$local_file' could not be uploaded to '$remote_file'.", FTP_ERR_UPLOADFILE_FAILED);
        } else {
            return true;
        }
    }
     ...
     * @see     FTP_ERR_OVERWRITELOCALFILE_FORBIDDEN, FTP_ERR_OVERWRITELOCALFILE_FAILED, FTP_ERR_OVERWRITELOCALFILE_FAILED, FTP_ERR_REMOTEPATHNODIR, FTP_ERR_LOCALPATHNODIR,FTP_ERR_CREATELOCALDIR_FAILED
     */
    ...
    function getRecursive($remote_path, $local_path, $overwrite = false, $mode = null)
    {
        ...
        if (!$this->_check_dir($remote_path)) {
            return $this->raiseError("Given remote-path '$remote_path' seems not to be a directory.", FTP_ERR_REMOTEPATHNODIR);
        }
        if (!$this->_check_dir($local_path)) {
            return $this->raiseError("Given local-path '$local_path' seems not to be a directory.", FTP_ERR_LOCALPATHNODIR);
        }

        if (!@is_dir($local_path)) {
            $res = @mkdir($local_path);
            if (!$res) {
                return $this->raiseError("Could not create dir '$local_path'", FTP_ERR_CREATELOCALDIR_FAILED);
            }
        }
        $dir_list = array();
        $dir_list = $this->ls($remote_path, FTP_DIRS_ONLY);
        foreach ($dir_list as $dir_entry) {
        ...
        $file_list = array();
        $file_list = $this->ls($remote_path, FTP_FILES_ONLY);
        foreach ($file_list as $file_entry) {
            $remote_file = $remote_path.$file_entry["name"];
     ...
     * @param   int    $mode        (optional) The transfermode (either FTP_ASCII or FTP_BINARY).
     * @return  mixed               True on succes, otherwise PEAR::Error
     * @see     FTP_ERR_LOCALFILENOTEXIST, FTP_ERR_OVERWRITEREMOTEFILE_FORBIDDEN, FTP_ERR_UPLOADFILE_FAILED, FTP_ERR_LOCALPATHNODIR, FTP_ERR_REMOTEPATHNODIR
     */
     ...
     * @see     FTP_ERR_HOSTNAMENOSTRING
     */
    
    function setHostname($host)
    {
        if (!is_string($host)) {
            return PEAR::raiseError("Hostname must be a string.", FTP_ERR_HOSTNAMENOSTRING);
        }
        $this->_hostname = $host;
        return true;
    }
     ...
     * @return  bool True on success, otherwise PEAR::Error
     * @see     FTP_ERR_PORTLESSZERO
     */
    
    function setPort($port)
    {
        if (!is_int($port) || ($port < 0)) {
            PEAR::raiseError("Invalid port. Has to be integer >= 0", FTP_ERR_PORTLESSZERO);
        }
        $this->_port = $port;
        return true;
    }
     ...
     * @return  mixed True on success, otherwise PEAR::Error
     * @see     FTP_ERR_USERNAMENOSTRING
     */
    
    function setUsername($user)
    {
        if (empty($user) || !is_string($user)) {
            return PEAR::raiseError('Username $user invalid.', FTP_ERR_USERNAMENOSTRING);
        }
        $this->_username = $user;
    }
     ...
     * @return  void
     * @see     FTP_ERR_PASSWORDNOSTRING
     */
    
    function setPassword($password)
    {
        if (empty($password) || !is_string($password)) {
            return PEAR::raiseError('Password xxx invalid.', FTP_ERR_PASSWORDNOSTRING);
        }
    ...
    function setMode($mode)
    {
        if (($mode == FTP_ASCII) || ($mode == FTP_BINARY)) {
            ...
            return $this->raiseError('FTP-Mode has either to be FTP_ASCII or FTP_BINARY', FTP_ERR_NOMODECONST);
        }
    }
     ...
     * @return  bool True on success, otherwise PEAR::Error
     * @see     FTP_ERR_TIMEOUTLESSZERO, FTP_ERR_SETTIMEOUT_FAILED
     */
     
    function setTimeout ( $timeout = 0 ) 
    {
        if (!is_int($timeout) || ($timeout < 0)) {
            return PEAR::raiseError("Timeout $timeout is invalid, has to be an integer >= 0", FTP_ERR_TIMEOUTLESSZERO);
        }
        $this->_timeout = $timeout;
        ...
        if (!$res) {
            return PEAR::raiseError("Set timeout failed.", FTP_ERR_SETTIMEOUT_FAILED);
        }
        return true;
    }        
     ...
     * @return  mixed             True on success, otherwise PEAR::Error
     * @see     FTP_ERR_EXTFILENOTEXIST, FTP_ERR_EXTFILEREAD_FAILED
     */
    
    function getExtensionsFile($filename)
    {
        if (!file_exists($filename)) {
            return $this->raiseError("Extensions-file '$filename' does not exist", FTP_ERR_EXTFILENOTEXIST);
        }

        if (!is_readable($filename)) {
            return $this->raiseError("Extensions-file '$filename' is not readable", FTP_ERR_EXTFILEREAD_FAILED);
        }
    ...
    /**
     * Adds a FTP_Observer instance to the list of observers 
     * that are listening for messages emitted by this FTP instance.
     *
     * @param   object   $observer     The FTP_Observer instance to attach 
     *                                 as a listener.
    ...
    /**
     * Removes a FTP_Observer instance from the list of observers.
     *
     * @param   object   $observer     The FTP_Observer instance to detach 
    ...
    function _rm_file($file)
    {
        ...
        if (!$res) {
            return $this->raiseError("Could not delete file '$file'.", FTP_ERR_DELETEFILE_FAILED);
        } else {
            return true;
        }
    }
     ...
     * @return  mixed        True on success, otherwise PEAR::Error
     * @see     FTP_ERR_REMOTEPATHNODIR, FTP_ERR_DELETEDIR_FAILED
     */
    
    function _rm_dir($dir)
    {
        if (substr($dir, (strlen($dir) - 1), 1) != "/") {
            return $this->raiseError("Directory name '$dir' is invalid, has to end with '/'", FTP_ERR_REMOTEPATHNODIR);
        }
        $res = @ftp_rmdir($this->_handle, $dir);
        if (!$res) {
            return $this->raiseError("Could not delete directory '$dir'.", FTP_ERR_DELETEDIR_FAILED);
        } else {
            return true;
        }
    }
    ...
    function _list_and_parse($dir)
    {
        ...
        if (!is_array($dir_list)) {
            return PEAR::raiseError('Could not get raw directory listing.', FTP_ERR_RAWDIRLIST_FAILED);
        }
        ...
        @usort($dirs_list, array("FTP", "_nat_sort"));
        @usort($files_list, array("FTP", "_nat_sort"));
     ...
     * @see     FTP_ERR_DIRLIST_UNSUPPORTED
     */
    ...
    foreach ($dir_list as $entry) {
        ...
        $error = 'The list style of your server seems not to be supported. Please email a "$ftp->ls(FTP_RAWLIST);" output plus info on the server to the maintainer of this package to get it supported! Thanks for your help!';
        return PEAR::raiseError($error, FTP_ERR_DIRLIST_UNSUPPORTED);
    }
    /**
    ...
    function _parse_Date($date)
    {
        ...
        $res = strtotime($date);
        if (!$res) {
            return $this->raiseError('Dateconversion failed.', FTP_ERR_DATEFORMAT_FAILED);
        }
        return $res;
    }
