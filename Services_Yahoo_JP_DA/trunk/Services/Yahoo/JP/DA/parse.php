...
require_once 'AbstractDA.php';

/**
 * Services_Yahoo_JP_DA_Parse
 *
 ...
 */
class Services_Yahoo_JP_DA_Parse extends Services_Yahoo_JP_DA_AbstractDA
{
    /**
     * api url
     *
