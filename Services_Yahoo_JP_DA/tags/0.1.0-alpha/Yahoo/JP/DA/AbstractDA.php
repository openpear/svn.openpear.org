 ...
 * @version   SVN: $Id: AbstractDA.php,v 1.1 2008/04/28 15:59:30 tetsuya Exp $
 */

require_once 'Services/Yahoo/JP/DA/Response.php';
 ...
 * types of DA that available through Services_Yahoo.
 *
 * @category  Services
 * @package   Services_Yahoo_JP_DA
 * @author    Hideyuki Shimooka <shimooka@doyouphp.jp>
 ...
 */
abstract class Services_Yahoo_JP_DA_AbstractDA
{
    /**
     * parameter
     *
     ...
     * @var    array
     */
    protected $parameters = array('appid' => 'PEAR_Services_Y_JP_DA');

    /**
     * Submits the DA
     *
     * This method submits the DA and handles the response.  It
     * returns an instance of Services_Yahoo_Result which may be used
     * to further make use of the result.
     *
     * @return object Services_Yahoo_Response DA result
    ...
    public function submit()
    {
        ...
        return new Services_Yahoo_JP_DA_Response($request);
    }
