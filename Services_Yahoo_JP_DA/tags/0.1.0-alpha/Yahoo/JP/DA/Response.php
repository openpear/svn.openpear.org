...
/**
 * Services_Yahoo DA Response class
 *
 ...
 */
class Services_Yahoo_JP_DA_Response implements Iterator
{
    /**
     * validate flag
     *
    ...
    public function __construct(HTTP_Request $request)
    {
        ...
        if ($this->_isError() == true) {
            $exception = new Services_Yahoo_Exception("DA query failed");
