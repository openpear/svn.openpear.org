...
class selectorToXPathTest extends PHPUnit_Framework_TestCase
{
    ...
    public function toXPathData()
    {
        return array(
            ...
            array('E:nth-of-type(3n + 1 )', '//E[position() mod 3 = 1]'),
            array('E:nth-of-type(+3n-2)', '//E[position() mod 3 = 1]'),
            array('E:nth-of-type(n )', '//E'),
            array('E:nth-of-type(0n+ 1)', '//E[position() = 1]'),
