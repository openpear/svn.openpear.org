...
/**
 * Services_Yahoo_JP Furigana Response
 *
 * PHP version 5
 *
 ...
 * @version   SVN: $Id: Response.php,v 1.1 2008/04/28 15:59:30 tetsuya Exp $
 */

/**
 * Services_Yahoo Furigana Response class
 *
 * This class provides methods for accessing the response of a category
 * request.
 *
 * @category  Services
 * @package   Services_Yahoo_JP_Furigana
 ...
 */
class Services_Yahoo_JP_Furigana_Response implements Iterator
{
    /**
     * validate flag
     *
    ...
    public function __construct(HTTP_Request $request)
    {
        ...
        if ($this->_isError() == true) {
            $exception = new Services_Yahoo_Exception("Furigana query failed");
    ...
    {
        return count((array)$this->xml->Result->WordList->Word);
    }
    ...
    {
        return (array)$this->xml->Result->WordList->Word[$this->_iteratorCounter];
    }
    ...
    public function next()
    {
        ...
        if (!isset($this->xml->Result->WordList->Word[$this->_iteratorCounter])) {
    ...
    private function _parseRequest()
    {
        ...
        if ($this->xml === false) {
            throw
                new Services_Yahoo_Exception("The response contained no valid XML");
        }
    }
    ...
    {
        return
            in_array($this->_request->getResponseCode(), array(400, 403, 404, 503));
    }
